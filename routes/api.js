...
let createChat = function (req, res, next) {
  ...
  Firebase.createChat(user_id, title, member_id_list).then(function (chat_id) {
    res.json({
...
let addChatMessage = function (req, res, next) {
  ...
  Firebase.addChatMessage(chat_id, user_id, now.toISOString(), message).then(function () {
    res.json({
...
let deleteChatMembers = function (req, res, next) {
  ...
  Firebase.removeChatMembers(chat_id, user_id_list).then(function () {
    res.json({
...
let addChatMembers = function (req, res, next) {
  ...
  Firebase.addChatMembers(chat_id, user_id_list).then(function () {
    res.json({
...
var validateGroupRecipient = function (group, act) {
  ...
  if (!_.some(recipients, function (item) {
      return item.id === group.id && item.objectType === group.objectType;
    })) {
