        ...
        app.use(helmet({
            contentSecurityPolicy: {
                directives: {
                    ...
                    "script-src": ["'self'", "'unsafe-inline'", "'unsafe-eval'"].concat(config.noCDN ? [] : ["cdnjs.cloudflare.com", "ajax.googleapis.com"]),
                    "style-src": ["'self'", "'unsafe-inline'"].concat(config.noCDN ? [] : ["cdnjs.cloudflare.com"]),
                    "img-src": ["*"],
                    "object-src": ["'none'"],
                    "media-src": ["*"],
